...
let tasks = JSON.parse(localStorage.getItem("tasks")) || {
  ...
  function createConfirmationElements() {
    ...
    cancelConfirmationBtn = cancelBtn;
    confirmActionBtn = confirmBtn;
  }
...
function confirmClearArchive() {
  ...
  function toggleViewOptions() {
    ...
    viewDropdown.classList.add("show")
    ...
    // Remove any existing view dropdown
    ...
    if (existingDropdown) {
      ...
      viewDropdown.classList.add("view-dropdown")
